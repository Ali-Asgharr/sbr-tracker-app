...
if st.session_state._running:
    ...
    if next_phase == 1:
        badge = '<div style="display:flex;align-items:center;gap:5px;"><div class="pulse"></div><span class="prun-txt">Phase 1 running...</span></div>'
        ...
        badge = '<div style="display:flex;align-items:center;gap:5px;"><div class="pulse"></div><span class="prun-txt">Phase 2 running...</span></div>'
        render_log_inline(log, badge)
        try:
        ...
        badge = '<div style="display:flex;align-items:center;gap:5px;"><div class="pulse"></div><span class="prun-txt">Phase 3 running...</span></div>'
        render_log_inline(log, badge)
        try:
        ...
        badge = '<div style="display:flex;align-items:center;gap:5px;"><div class="pulse"></div><span class="prun-txt">Phase 4 running...</span></div>'
        render_log_inline(log, badge)
        try:

...
with st.sidebar:
    ...
    tracker_file    = st.file_uploader("Master-Tracker",  type=["xlsx"],       key="f_t",  label_visibility="collapsed")
    st.caption("Master-Tracker.xlsx")
    bdr_file        = st.file_uploader("BDR",             type=["csv"],        key="f_b",  label_visibility="collapsed")
    st.caption("BDR.csv")
    submission_file = st.file_uploader("Submission",      type=["xlsx","csv"], key="f_s",  label_visibility="collapsed")
    st.caption("Submission.xlsx / .csv")
    payment_file    = st.file_uploader("Payment Report",  type=["csv","xlsx"], key="f_p",  label_visibility="collapsed")
    st.caption("Payment-Report.csv / .xlsx")
    doclog_file     = st.file_uploader("Doc-Log",         type=["csv","xlsx"], key="f_d",  label_visibility="collapsed")
    st.caption("Doc-Log.csv / .xlsx")
